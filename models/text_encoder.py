...
class PromptLearner(nn.Module):
    def __init__(self, classnames, clip_model):
        ...
        self.ctx = nn.Parameter(ctx_vectors)  # (num_classes, context_length, 512), to be optimized
        ...
        with torch.no_grad():
            ...
            embedding = clip_model.token_embedding(tokenized_prompts).type(dtype)  # (num_classes, 77, 512)
